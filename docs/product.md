...
- **Stats** — durable log of finished sessions with today / 7-day / all-time views, per-agent split, week-over-week comparison and personal best; back-filled from existing transcripts on first launch
